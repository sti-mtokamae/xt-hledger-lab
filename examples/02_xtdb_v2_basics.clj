...
;; v2 では {:xtdb.api/tx-ops [...]} スタイル
(xt/submit-tx node
  {:xtdb.api/tx-ops
   [{:xtdb.api/op :put
     :xtdb.api/table :trade-docs
     :xt/id "INV-2024-001"
     :type "Invoice"
     ...
     :currency "USD"
     :status "Draft"
     :issue-date #inst "2024-05-01T00:00:00Z"}]})
...
(xt/submit-tx node
  {:xtdb.api/tx-ops
   [{:xtdb.api/op :put
     ...
     :status "Confirmed"          ; ← 変更
     :issue-date #inst "2024-05-01T00:00:00Z"
     :confirmed-date #inst "2024-05-10T00:00:00Z"}]})
...
(xt/submit-tx node
  {:xtdb.api/tx-ops
   [{:xtdb.api/op :put
     ...
     :issue-date #inst "2024-05-01T00:00:00Z"
     :confirmed-date #inst "2024-05-10T00:00:00Z"
     :correction-note "金額修正: 1500 -> 1600 USD"
     :xt/valid-time #inst "2024-05-01T00:00:00Z"}]})  ; ← 有効時刻を過去に指定
